...
export type main_ReturnType = {result: [number | string, boolean | null]; x?: any; y?: any;};
export type main_ArgsType = undefined;

export type complex__ReturnType = Record<string, (number | string)[]>;
export type complex__ArgsType = undefined;
